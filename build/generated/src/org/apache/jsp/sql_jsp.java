  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            String cou = request.getParameter("t4");
            ...
            try{
                ...
                String q ="Insert into students (ROLL_no,Name,Fathers_Name,Course) values ("+rno+",'"+name+"','"+Fname+"','"+cou+"')";
                st.executeUpdate(q);
                out.println("Values Inserted In table");
                con.close();
